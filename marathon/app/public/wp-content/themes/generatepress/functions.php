...
function my_acf_init_block_types() {
    ...
    if( function_exists('acf_register_block_type') ) {
        // Register a marathon block.
        acf_register_block_type(array(
            'name'              => 'marathon-block',
            'title'             => __('Marathon Block'),
            'description'       => __('A custom marathon block.'),
            'render_template'   => 'template-parts/blocks/marathon-block/marathon-block.php',
            'category'          => 'formatting',
            'icon'              => 'admin-comments',
            'keywords'          => array( 'marathon', 'block' ),
        ));
    }
}
